    ...
    <React.Fragment>
        ...
        <div className="Discount-content">
            ...
            <div className="Discount-list mt-44">
                <List leftText={"Weekly discount "} rightText={[<strong style={{"opacity":'1',"fontSize":'large'}}>15%</strong>]} rightArrowNone={true} />
            </div>
            <p className="Discount-small_text">Recommended: 15%</p>
            <div className="Discount-list mt-44">
                <List leftText={"Monthly discount"} style={{"borderBottom":'1px solid #00000040'}} rightText={[<strong style={{"opacity":'1',"fontSize":'large'}}>25%</strong>]} rightArrowNone={true} />
            </div>
